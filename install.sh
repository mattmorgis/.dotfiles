...
ln -sfn "$DOTFILES_DIR/zfunc" "$HOME/.zfunc"
...
ln -sfn "$DOTFILES_DIR/config/aerospace/aerospace.toml" "$HOME/.config/aerospace/aerospace.toml"
...
if [ -f "$DOTFILES_DIR/git/gitconfig-personal" ]; then
    ln -sfn "$DOTFILES_DIR/git/gitconfig-personal" "$HOME/.config/git/gitconfig-personal"
fi

if [ -f "$DOTFILES_DIR/git/gitconfig-work" ]; then
    ln -sfn "$DOTFILES_DIR/git/gitconfig-work" "$HOME/.config/git/gitconfig-work"
fi
